...
public class R {
    ...
    public static final String HTML_R_Node="<font color='#000052'><strong>";
    public static final String HTML_CL_R_Node="</strong></font>";
    
    public static final String HTML_Node="<font color='#000000>";
    public static final String HTML_CL_Node = "</font>";
    
    public static final String HTML_Hint="<font color='#888888><i>";
    public static final String HTML_CL_Hint="</i></font>";
    
    public static final String HTML_Val = "<font color='#008800><em>";
    public static final String HTML_CL_Val = "</em></font>";
    
    public static final String HTML_Prop ="<font color='#008800>";
    public static final String HTML_CL_Prop ="</font>";
    
    //About Document
    @StaticResource
    public static final String ABOUT_BART = "it/unibas/bartgui/resources/aboutbart/AboutBartTechnicalReport.pdf";
    
    //IMAGE
    @StaticResource
    public static final String IMAGE_NODE_DIRTYSTRTABLE = "it/unibas/bartgui/resources/icons/inkblot.png";
    @StaticResource
    ...
    @StaticResource
    public static final String IMAGE_New_FILE = "it/unibas/bartgui/resources/icons/new-file.png";
    @StaticResource
    ...
    @StaticResource
    public static final String IMAGE_SETTINGS="it/unibas/bartgui/resources/icons/wrench.png";
    @StaticResource
    ...
    @StaticResource
    public static final String IMAGE_NODE_CONFIG="it/unibas/bartgui/resources/icons/setting.png";   
    @StaticResource
