...
public class TestInstanceSimilarityBlock extends TestCase {

    private final static Logger logger = LoggerFactory.getLogger(TestInstanceSimilarityBlock.class);

    private IComputeInstanceSimilarity similarityChecker = new ComputeInstanceSimilarityBlock();
